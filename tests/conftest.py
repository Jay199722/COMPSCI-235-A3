...
from TMB.adapters import memory_repository, database_repository
from TMB.adapters.orm import metadata, map_model_to_tables
from TMB.adapters.memory_repository import MemoryRepository

# TODO: You have to adapt these paths to your file structure
TEST_DATA_PATH_MEMORY = os.path.join('D:', os.sep, 'pyc', 'venv', 'COMPSCI-235-A3', 'tests', 'data', 'memory')
TEST_DATA_PATH_DATABASE = os.path.join('D:', os.sep, 'pyc', 'venv', 'COMPSCI-235-A3', 'tests', 'data', 'database')

TEST_DATABASE_URI_IN_MEMORY = 'sqlite://'
TEST_DATABASE_URI_FILE = 'sqlite:///TMB-test.db'
